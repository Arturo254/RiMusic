...
@NonNullApi
public class RiMusicProjectDependency extends DelegatingProjectDependency {

    @Inject
    public RiMusicProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
